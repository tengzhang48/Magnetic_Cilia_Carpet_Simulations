function [lattice_model] = create_2Dmodel(obj)
...
% Magnetic force
km = zeros(Ne,12);                                                           % store the stiffness of the magnetic force
fm = zeros(nnode,3); 
...
lattice_model.  = [length(lattice_model.M_atom),length(k_bond),0,0,length(improper_v)];
