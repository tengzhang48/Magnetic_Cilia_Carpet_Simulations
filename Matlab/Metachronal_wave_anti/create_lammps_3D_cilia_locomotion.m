...
Lx_b = 60e-3/units(2); % normlized by length unit
Ly_b = 8e-3/units(2); % normlized by length unit
Lz_b = 40e-3/units(2); % normlized by length unit
...
rho = 4000/units(6);  % normlized by density unit      % Density
...
S1=solid(mu,rho,lambda,'0.8mm_36mm_8x1_node.csv','0.8mm_36mm_8x1_element.csv',480,mu2,rho2,lambda2,1);  
